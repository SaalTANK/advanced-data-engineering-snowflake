...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/SaalTANK') -- URL to your GitHub profile
...
CREATE OR REPLACE GIT REPOSITORY course_repo.public.advanced_data_engineering_snowflake
  ...
  ORIGIN = 'https://github.com/SaalTANK/advanced-data-engineering-snowflake.git' -- Insert URL of forked repo
